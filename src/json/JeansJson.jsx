...
const Jeansdata = [
  {
    id: 1,
    description:
      "Stylish and durable jeans with a comfortable fit, made for everyday wear and all-day comfort. 👖",
    image: j1,
    tittle: "Diesel Tapered",
    price: 599,
    quantity: 1,
  },
  {
